...
[CreateAssetMenu(fileName = "Chameleon", menuName = "Enemies/Chameleon")]
public class Chameleon : Enemy
{
    ...
    public void OnAttack(EnemyBehaviour thisBehaviour)
    {
        ...
        pjBehaviour.moveDirection = thisBehaviour.GetComponent<SpriteRenderer>().flipX ? new Vector2(1, 0) : new Vector2(-1, 0);

        pj.GetComponent<SpriteRenderer>().flipY = pjBehaviour.moveDirection.x > 0 ? true : false;
